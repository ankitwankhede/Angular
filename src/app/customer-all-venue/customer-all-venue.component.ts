...
@Component({
  selector: 'app-customer-all-venue',
  templateUrl: './customer-all-venue.component.html',
  styleUrls: ['./customer-all-venue.component.css']
})
export class CustomerAllVenueComponent implements OnInit {
